...
@section('content')
    <div class="container mx-auto px-4 py-6">
        <!-- رأس الصفحة -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">تعديل المستوى</h1>
            <p class="text-gray-600 mt-1">تعديل بيانات المستوى: {{ $level->title }}</p>
        </div>
                ...
                <div class="flex items-start mb-6">
                    <div class="flex items-center h-5">
                        <input id="publish" name="publish" type="checkbox" value="{{ old('publish', $level->publish) }}"
                            class="w-4 h-4 border border-blue-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300" {{ old('publish', $level->publish) ? 'checked' : '' }}>
                    </div>
