...
@section('content')
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-1">تعديل بيانات المستخدم: {{ $user->email ?? $user->phone }}</p>
        </div>
            ...
            <form method="POST" action="{{ route('admin.users.update', $user) }}" class="p-6">
                ...
                <div class="mb-5">
                    <label for="password" class="block mb-2 text-sm font-medium text-gray-900">
                        كلمة المرور <span class="text-gray-500 text-xs">(اترك فارغاً إذا لم ترد التغيير)</span>
                    </label>
                    <div class="relative">
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
